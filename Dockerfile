...
# Dentro del contenedor se renombra como app_eureka_server.jar.
COPY ${JAR_FILE} app_eureka_server.jar

# Expone el puerto que usa Eureka Server.
# Eureka trabaja en el puerto 8761.
EXPOSE 8761
